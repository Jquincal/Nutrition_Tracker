...
CREATE INDEX IF NOT EXISTS idx_meals_user_date ON meals(clerk_user_id, logged_at);
CREATE INDEX IF NOT EXISTS idx_workouts_user_date ON workouts(clerk_user_id, logged_at);
CREATE INDEX IF NOT EXISTS idx_custom_foods_user ON custom_foods(clerk_user_id);
